                ...
                <div class="col-12">
                    ...
                    @if(isset($data) and !empty($data[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminProductEditPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($data as $veri)
                                            ...
                                            <input type="hidden" name="productid" value="{{$veri->productid}}">
                                                ...
                                                <div class="col-md-9 col-xl-12">
                                                    <div class="row">
                                                        ...
                                                        <!--<div class="col-md-12 col-lg-12 mb-3">
                                                            ...
                                                            <textarea name="ozet[]" id="editor2{{$veri->diletiket}}" cols="30" rows="10">{{$veri->ozet}}</textarea>
                                                            <script>
                                                                CKEDITOR.replace( 'editor2{{$veri->diletiket}}' );
                                                            </script>
                                                        </div>
                                                        <div class="col-md-12 col-lg-12 mb-3">
                                                            <style>
                                                            ...
                                                            <textarea name="ozellikleri[]" id="editor3{{$veri->diletiket}}" cols="30" rows="10">{{$veri->ozellikler}}</textarea>
                                                            <script>
                                                                CKEDITOR.replace( 'editor3{{$veri->diletiket}}' );
                                                            </script>
                                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-label">Ana Kategori Seçin</div>
                                                        <select @if(app('request')->input('focus')=="select") style="background: #f79696" @endif name="kategori" class="form-select">
                                                            <option value="" selected>Seçiniz</option>
                                                            {{$anakategoriler}}
                                                            @foreach($anakategoriler as $anakategori)
                                                                <option @if($data[0]['kategori'] == $anakategori->catid) selected value="{{$anakategori->catid}}" @else value="{{$anakategori->catid}}" @endif>{{$anakategori->baslik}}</option>
                                                            @endforeach
                                                        </select>
                                                        <small>Kategoriyi seçmezseniz ürün durumu otomatik kapalı olarak gelecektir.</small>
                                                    </div>
                                                    <div class="mb-3" style="text-align: center;">
                                                        @if($data[0]['image'])
                                                            <img style="max-height: 150px;" src="{{asset($data[0]['image'])}}" alt="{{asset($data[0]['baslik'])}}">
                                                            <br>
                                                            <small>Eğer yeni görsel iletmezseniz eski görsel ile devam edilecektir.</small>
                                                        @endif
                                                        <label for="formFile" class="form-label">Ürün 1. Görsel</label>
                                                    ...
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="fiyat" value="{{$data[0]['fiyat']}}"/>
                                                        <small>Sadece rakam ile belirtin.</small>
                                                    </div>
                                                    <!--<div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label">Anasayfada gözüksün mü?</label>
                                                            @if($veri->anasayfadurum==1)
                                                                <label class="switch">
                                                                    <input name="anasayfadurum" type="checkbox" checked>
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            @else
                                                                <label class="switch">
                                                                    <input type="hidden" name="anasayfadurum" value="2">
                                                                    <input name="anasayfadurum" type="checkbox">
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label">Footerda gözüksün mü?</label>
                                                            @if($veri->footerdurum==1)
                                                                <label class="switch">
                                                                    <input name="footerdurum" type="checkbox" checked>
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            @else
                                                                <label class="switch">
                                                                    <input type="hidden" name="footerdurum" value="2">
                                                                    <input name="footerdurum" type="checkbox">
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            @endif
                                                        </div>
