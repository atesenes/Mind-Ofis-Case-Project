                ...
                <div class="col-12">
                    ...
                    @if(isset($diller) and !empty($diller[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminAddProductPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <div class="col-md-9 col-xl-12">
                                                    <div class="row">
                                                        ...
                                                        <!--<div class="col-md-12 col-lg-12 mb-3">
                                                            ...
                                                            <textarea name="ozet[]" id="editor2{{$dil->diletiket}}" cols="30" rows="10"></textarea>
                                                            <script>
                                                                CKEDITOR.replace( 'editor2{{$dil->diletiket}}' );
                                                            </script>
                                                        </div>
                                                        <div class="col-md-12 col-lg-12 mb-3">
                                                            <style>
                                                            ...
                                                            <textarea name="ozellikleri[]" id="editor3{{$dil->diletiket}}" cols="30" rows="10"></textarea>
                                                            <script>
                                                                CKEDITOR.replace( 'editor3{{$dil->diletiket}}' );
                                                            </script>
                                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-label">Ürün Kategorisi Seçin</div>
                                                        <select name="kategori" class="form-select">
                                                            <option value="" selected>Seçiniz</option>
                                                            @foreach($anakategoriler as $anakategori)
                                                                <option value="{{$anakategori->catid}}">{{$anakategori->baslik}}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    @php
                                                        $sonsira=\App\Models\siteProducts::orderBy('sira','DESC')->first();
                                                    @endphp
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <label class="form-label">Sıra</label>
                                                        <input type="text" class="form-control" name="sira" value="@if(empty($sonsira->sira))1 @else {{$sonsira->sira+1}} @endif"/>
                                                    </div>
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <label class="form-label">Fiyat</label>
                                                        <input type="number" class="form-control" name="fiyat" placeholder="20"/>
                                                    ...
                                                    <!--<div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="switch">
                                                                <input name="anasayfadurum" type="hidden" value="2" >
                                                                <input name="anasayfadurum" type="checkbox" value="1">
                                                    ...
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="switch">
                                                                <input name="footerdurum" type="hidden" value="2" >
                                                                <input name="footerdurum" type="checkbox" value="1">
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </div>
                                                    </div>
