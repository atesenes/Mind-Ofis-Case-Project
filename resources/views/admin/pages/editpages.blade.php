                ...
                <div class="col-12">
                    ...
                    @if(isset($data) and !empty($data[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminPagesEditPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($data as $veri)
                                            ...
                                            <input type="hidden" name="pagesid" value="{{$veri->pagesid}}">
