                ...
                <div class="col-12">
                    ...
                    @if(isset($data) and !empty($data[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminKurumsalEditPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($data as $veri)
                                            ...
                                            <input type="hidden" name="kurumsalid" value="{{$veri->kurumsalid}}">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        ...
                                                        <select name="sayfaturu" class="form-select">
