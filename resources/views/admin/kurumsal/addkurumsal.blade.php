                ...
                <div class="col-12">
                    ...
                    @if(isset($diller) and !empty($diller[0]))
                        ...
                        <div class="card-header" style="border: none">
                            <h4 class="card-title">Yeni Kurumsal Sayfa Ekle</h4>
                        </div>
                        <div class="card-tabs">
                            <!-- Cards navigation -->
                            ...
                            <form action="{{route('adminAddKurumsalPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($diller as $dil)
                                            ...
                                            <input type="hidden" name="kurumsalid" value="{{$rand}}">
                                            <div id="{{$dil->diletiket}}" class="col-md-9 tabcontent">
                                                <div class="col-md-9 col-xl-12">
                                                    <div class="row">
                                                        <div class="col-md-6 col-lg-6 mb-3">
                                                            <label class="form-label">Başlık</label>
                                                            <input type="text" class="form-control" name="baslik[]" placeholder="Sayfa Başlık" required/>
                                                        </div>
                                                        <div class="col-md-6 col-lg-6 mb-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-label">Sayfa Kategorisi Seçin</div>
                                                        <select required name="sayfaturu" class="form-select">
                                                            <option value="" selected>Seçiniz</option>
                                                            <option value="hakkimizda">@lang('admin.hakkimizda')</option>
                                                            <option value="servisler">@lang('admin.servisler')</option>
