                ...
                <div class="col-12">
                    ...
                    @if(isset($diller) and !empty($diller[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminAddBlogsPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($diller as $dil)
                                            ...
                                            <input type="hidden" name="blogid" value="{{$rand}}">
                                            <div id="{{$dil->diletiket}}" class="col-md-9 tabcontent">
                                                <div class="col-md-9 col-xl-12">
                                                    <div class="row">
                                                        <div class="col-md-6 col-lg-6 mb-3">
                                                            <label class="form-label">Başlık</label>
                                                            <input type="text" class="form-control" name="baslik[]" placeholder="Blog Başlık"/>
                                                        </div>
                                                        <div class="col-md-6 col-lg-6 mb-3">
                                                        ...
                                                        <div class="col-md-12 col-lg-12 mb-3">
                                                            ...
                                                            <textarea name="ozet[]" id="editor-2{{$dil->diletiket}}" cols="30" rows="10"></textarea>
                                                            <script>
                                                                CKEDITOR.replace( 'editor-2{{$dil->diletiket}}' );
                                                            </script>
                                                        </div>
                                                        <div class="col-md-6 col-lg-6 mb-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    <div class="mb-3">
                                                        <label for="formFile" class="form-label">Blog Görsel</label>
                                                        <input type="file" class="form-control" name="image" id="inputGroupFile02">
                                                    </div>
                                                    @php
                                                        $sonsira=\App\Models\siteBlogs::orderBy('sira','DESC')->first();
                                                    @endphp
                                                    <div class="col-md-12 col-lg-12 mb-3">
