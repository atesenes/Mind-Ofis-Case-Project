                ...
                <div class="col-12">
                    ...
                    @if(isset($diller) and !empty($diller[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminSirketAddPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($diller as $dil)
                                            <div id="{{$dil->diletiket}}" class="col-md-9 tabcontent">
                                                <div class="col-md-9 col-xl-12">
                                                    <input type="hidden" name="sirketid" value="{{rand(11111111111,99999999999)}}">
                                                    <div class="row">
                                                        <div class="col-md-6 col-lg-6 mb-3">
                                                            <label class="form-label">Şirket İsmi</label>
                                                            <input type="text" class="form-control" name="sirketname" placeholder="Şirket İsmi" required/>
                                                        </div>
                                                        <div class="col-md-12 col-lg-12 mb-3">
                                                            ...
                                                            <textarea name="aciklama" id="editor{{$dil->diletiket}}" cols="30" rows="10"></textarea>
                                                            <script>
