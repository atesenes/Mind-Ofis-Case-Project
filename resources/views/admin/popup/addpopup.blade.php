            ...
            <div class="row row-cards">
                <div class="col-12">
                    ...
                    <div class="card-header" style="border: none">
                        <h4 class="card-title">Yeni Pop-up Ekle</h4>
                    </div>
                    <div class="card-tabs">
                                        ...
                                        <div class="col-md-9 col-xl-12">
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12 mb-3">
                                                    <label class="form-label">Pop-up Başlık</label>
                                                    <input type="text" class="form-control" name="baslik" placeholder="Pop-up Başlık"/>
                                                </div>
                                                <div class="col-md-12 col-lg-12 mb-3">
                                                    <label class="form-label">Pop-up İçerik</label>
                                                    <input type="text" class="form-control" name="baslik" placeholder="Pop-up Başlık"/>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mt-3">
                                            <fieldset class="form-fieldset">
                                                <div class="mb-3">
                                                    <label for="formFile" class="form-label">Pop-up Görsel</label>
