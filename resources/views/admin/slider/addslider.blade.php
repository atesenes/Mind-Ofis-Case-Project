        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-12">
                    ...
                    <form action="{{route('adminAddSliderPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                @foreach($diller as $dil)
                                    ...
                                    <input type="hidden" name="sliderid" value="{{$rand}}">
                                    <div id="{{$dil->diletiket}}" class="col-md-9 tabcontent">
                                        <div class="col-md-9 col-xl-12">
                                            <div class="row">
                                                <div class="col-md-6 col-lg-6 mb-3">
                                                    <label class="form-label">Başlık</label>
                                                    <input type="text" class="form-control" name="baslik[]" placeholder="Slider Başlık"/>
                                                </div>
                                                <div class="col-md-6 col-lg-6 mb-3">
                                                    <label class="form-label">Dış Link Yazısı</label>
                                                    <input type="text" class="form-control" name="dislikmetin[]" placeholder="Dış Link Metin"/>
                                                    <small>Eklenen linke ait görünecek metin</small>
                                                </div>
                                                <div class="col-md-6 col-lg-6 mb-3">
                                                    <label class="form-label">Dış Link</label>
                                                    <input type="text" class="form-control" name="dislik[]" placeholder="Dış Link"/>
                                                    <small>Eklenecek linkin başında "<b>http://</b>" olması gerekmektedir!</small>
                                                </div>
                                                <div class="col-md-6 col-lg-6 mb-3">
                                                    <label class="form-label">Kısa Açıklama</label>
                                                    <input type="text" class="form-control" name="kisaaciklama[]" placeholder="Telefon Giriniz"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mt-3">
                                            <fieldset class="form-fieldset">
                                                ...
                                                @php
                                                    $sonsira=\App\Models\siteSlider::orderBy('sira','DESC')->first();
                                                @endphp
