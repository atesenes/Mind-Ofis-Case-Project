                            ...
                            <table id="datatables" class="display" style="width:100%">
                                ...
                                @foreach($data as $kullanici)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('adminUserEdit',['id'=>$kullanici->userid])}}"><button class="btn btn-sm btn-light" style="width: 100%;margin-bottom: 5px">Düzenle</button></a>
                                            <br>
                                            <a href="{{route('adminUserDel',['id'=>$kullanici->userid])}}"><button class="btn btn-sm btn-light" style="width: 100%">Sil</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
