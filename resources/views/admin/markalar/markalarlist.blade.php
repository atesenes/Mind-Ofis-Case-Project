...
@section('icerik')
    ...
    <div class="page-body">
        <div class="container-xl d-flex flex-column justify-content-center">
            ...
            @if($data=="0")
                <div class="empty">
                    <p class="empty-title">Henüz çalışan eklenmemiş.</p>
                    <p class="empty-subtitle text-muted">
                        Hemen yeni bir görsel ekle.
                    </p>
                    <div class="empty-action">
                        <a href="{{route('adminAddMarka')}}" class="btn btn-success">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                            <i class="bi bi-briefcase-fill" id="headericon"></i>
                            Yeni Görsel Ekle
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('adminAddMarka')}}"><button style="position: absolute;right:15px;top:15px;" class="btn btn-sm btn-success">Yeni Görsel EKle</button></a>
                        </div>
                        <!-- DATATABLES BAŞI -->
