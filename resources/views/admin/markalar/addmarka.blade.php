            ...
            <div class="row row-cards">
                <div class="col-12">
                    ...
                    @endif
                        ...
                        <div class="card-tabs">
                            <form action="{{route('adminAddMarkaPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <div class="col-md-9 col-xl-12">
                                                    <div class="row">
                                                        <div class="col-md-12 col-lg-12 mb-3">
                                                            <label class="form-label">Görsel İsmi</label>
                                                            <input type="text" class="form-control" name="baslik" placeholder="Görsel İsmi"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    ...
                                                    @php
                                                        $sonsira=\App\Models\siteMarkalar::orderBy('sira','DESC')->first();
                                                    @endphp
                                                    <div class="col-md-12 col-lg-12 mb-3">
