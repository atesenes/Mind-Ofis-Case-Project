                ...
                <div class="col-12">
                    ...
                    @if(isset($diller) and !empty($diller[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminAddCatPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($diller as $dil)
                                            ...
                                            <input type="hidden" name="catid" value="{{$rand}}">
                                            <div id="{{$dil->diletiket}}" class="col-md-9 tabcontent">
                                                <div class="col-md-9 col-xl-12">
                                                    <div class="row">
                                                        <div class="col-md-12 col-lg-12 mb-3">
                                                            <label class="form-label">Başlık</label>
                                                            <input type="text" class="form-control" name="baslik[]" placeholder="Kategori Başlık"/>
                                                        </div>
                                                        <div class="col-md-12 col-lg-12 mb-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    @if(!empty($cats[0]->baslik))
                                                        <!--<div class="mb-3">
                                                            <label for="catselect" class="form-label">Ana Kategori Seçin</label>
                                                            <select name="topcatid" class="form-select" id="catselect" aria-label="Default select example">
                                                                <option value="" selected>Seçiniz</option>
                                                                @foreach($cats as $cat)
                                                                    <option value="{{$cat->catid}}">{{$cat->baslik}}</option>
                                                                @endforeach
                                                            </select>
                                                            <small>Alt kategori seçilmeyecekse boş bırakın.</small>
                                                        </div>-->

                                                    @endif
                                                    <div class="mb-3">
                                                        <label for="formFile" class="form-label">Kategori Görsel</label>
                                                        <input type="file" class="form-control" name="image" id="inputGroupFile02">
                                                    </div>
                                                    @php
                                                        $sonsira=\App\Models\siteCategoires::orderBy('sira','DESC')->first();
                                                    @endphp
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                    ...
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-group">
                                                            <label class="form-label">Menüde gözüksün mü?</label>
                                                            <label class="switch">
                                                                <input name="menudurum" type="hidden" value="2" >
                                                                <input name="menudurum" type="checkbox" value="1">
