                ...
                <div class="col-12">
                    ...
                    @if(isset($data) and !empty($data[0]))
                        ...
                        <div class="card-tabs">
                            ...
                            <form action="{{route('adminCatEditPost')}}" method="post" class="card" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @foreach($data as $veri)
                                            ...
                                            <input type="hidden" name="catid" value="{{$veri->catid}}">
                                            ...
                                            <div class="mt-3">
                                                <fieldset class="form-fieldset">
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        ...
                                                        <select name="topcatid" class="form-select">
                                                            <option value="" selected>Seçiniz</option>
                                                            {{$anakategoriler}}
                                                            @foreach($anakategoriler as $anakategori)
                                                                <option @if($data[0]['topcatid'] == $anakategori->catid) selected value="{{$anakategori->catid}}" @else value="{{$anakategori->catid}}" @endif>{{$anakategori->baslik}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="col-md-12 col-lg-12 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            @if($veri->durum==1)
                                                                <label class="switch">
                                                                    <input name="menudurum" type="checkbox" checked>
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            @else
                                                                <label class="switch">
                                                                    <input type="hidden" name="menudurum" value="2">
                                                                    <input name="menudurum" type="checkbox">
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            @endif
                                                        </div>
